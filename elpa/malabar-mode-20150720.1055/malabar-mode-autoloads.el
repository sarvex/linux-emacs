...

;;;### (autoloads nil "malabar-abbrevs" "malabar-abbrevs.el" (0 0
;;;;;;  0 0))
;;; Generated autoloads from malabar-abbrevs.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "malabar-abbrevs" '("malabar-abbrevs-" "define-malabar-abbrev-skeleton")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "malabar-ede-gradle" '("malabar-" "project-" "ede-" "gradle-outfile-name" "initialize-instance")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "malabar-ede-maven" '("maven2-outfile-name" "malabar-" "project-" "ede-" "initialize-instance")))

;;;***

;;;### (autoloads nil "malabar-import" "malabar-import.el" (0 0 0
;;;;;;  0))
;;; Generated autoloads from malabar-import.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "malabar-import" '("malabar-")))

;;;***

;;;### (autoloads nil "malabar-mode" "malabar-mode.el" (0 0 0 0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "malabar-mode" '("malabar-" "print-current-line-id" "interactive-region-or-string" "forward-gav")))

;;;***

;;;### (autoloads nil "malabar-project" "malabar-project.el" (0 0
;;;;;;  0 0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "malabar-project" '("malabar-")))

;;;***

;;;### (autoloads nil "malabar-http" "malabar-http.el" (0 0 0 0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "malabar-http" '("malabar-http-")))

;;;***

;;;### (autoloads nil "malabar-reflection" "malabar-reflection.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from malabar-reflection.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "malabar-reflection" '("malabar-" "define-tag-modifier-predicates")))

;;;***

;;;### (autoloads nil "malabar-semanticdb" "malabar-semanticdb.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from malabar-semanticdb.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "malabar-semanticdb" '("malabar-" "semanticdb-")))

;;;***

;;;### (autoloads nil "malabar-util" "malabar-util.el" (0 0 0 0))
;;; Generated autoloads from malabar-util.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "malabar-util" '("malabar-" "define-cached-function" "with-caches" "string-")))

;;;***

;;;### (autoloads nil "malabar-variables" "malabar-variables.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from malabar-variables.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "malabar-variables" '("malabar-")))

;;;***

;;;### (autoloads nil nil ("malabar-mode-pkg.el") (0 0 0 0))
