...

;;;### (autoloads nil "magit-rockstar" "magit-rockstar.el" (0 0 0
;;;;;;  0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "magit-rockstar" '("magit-debug-sections-1")))
